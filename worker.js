...
// Tithi question + today is not a tithi → answer directly, skip Claude.
      // But only if the user is asking about TODAY — not "this week" / "upcoming".
      ...
      const asksForward = /\b(this week|next week|upcoming|soon|coming up|any (tithi|fast)|next (few|couple))\b/i.test(text);
      if (isTithiQ && !todayIsTithi && !asksForward && user.community === 'jain') {
